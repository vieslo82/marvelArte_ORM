...
CREATE TABLE `cuadros` (
  ...
  `Fecha Creacion` varchar(10) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `Fecha Stock` varchar(10) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `Dimensiones` varchar(5) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `Tecnica` varchar(10) COLLATE utf8_spanish2_ci DEFAULT NULL,
  ...
  `Material Marco` varchar(10) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `Color Marco` varchar(10) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `Estilo Marco` varchar(10) COLLATE utf8_spanish2_ci DEFAULT NULL,
  PRIMARY KEY (`Codigo`)
...
-- Dump completed on 2016-10-11 20:08:28
